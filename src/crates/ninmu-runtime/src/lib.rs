...
pub use cache_stable::{
    compact_cache_stable, CacheStableCompactionConfig, CacheStableResult, CacheStableState,
};
pub use compact::{
...
pub use conversation::{
    auto_compaction_threshold_from_env, detect_needs_pro, escalate_model_name, ApiClient,
    ApiRequest, AssistantEvent, AutoCompactionEvent, ConversationRuntime, PromptCacheEvent,
    RuntimeError, StaticToolExecutor, summary_flash_model_hint, ToolError, ToolExecutor,
    TurnSummary,
};
pub use file_ops::{
