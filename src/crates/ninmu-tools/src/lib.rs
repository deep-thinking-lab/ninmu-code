...
mod tests {
    ...
    fn agent_fake_runner_can_persist_completion_and_failure() {
        ...
        let artifact = execute_agent_with_spawn(
            ...
            |job| {
                persist_agent_terminal_state(
                    ...
                    "completed",
                    Some(
                        "Completed ROADMAP #64. Files: src/crates/ninmu-tools/src/lib.rs ROADMAP.md. Diff stat: 2 files, +12/-1. Tested, committed, pushed as commit deadbee.",
                    ),
                    None,
                )
            },
        ...
        assert_eq!(
            ...
            "src/crates/ninmu-tools/src/lib.rs"
        );
        assert_eq!(
